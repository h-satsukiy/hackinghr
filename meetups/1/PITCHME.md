...
# Green
### 戦略_1：”気になる”を押してくれた方からスカウトを実施

# Wantedly
### 戦略_1：とりあえず求人を上位表示させ、たくさんの候補者の目に留まるようにする！
  - 社内応援依頼
    - 毎日15時に、求人の応援ボタンを押すようSlackで依頼

  - 新規求人公開
    - 月に1〜2回、内容はほぼ変えずにタイトルと写真のみを変更した求人を公開
    - なぜこれでランキングが上がるんだろう・・・？？weantedlyさん！
...
## Reproのスカウト戦略
### 戦略_1：マネージャークラスには社長からMessengerで！
#### 代表の平田がMessengerで候補者に直接アプローチした場合、
#### 返信率は驚異の<br>
<font size="15">
 <div style="text-align: center;">
65%程度！（平田体感値）
...
### 戦略_2：各チームのエース社員に協力してもらおう！
#### Attack Listを作成し、各チームのマネージャーに
#### イイと思った人には自分からアプローチしてもらいましょう！
#### 返信率は計測中（＞＜）

---

### 戦略_3：ゴールデンタイムは19時〜21時！
#### ゴールデンタイムの間に送付したスカウトメールの開封率は、
#### それ以外に比べて
<font size="15">
 <div style="text-align: center;">
1.5倍！
...
### メディア運営にも、戦略は必須だった！
自社の状況を分析し、最適なメディアを取捨選択した上で<br>
メディアを最大限効果的に活用できる運用方法を検討するべき！

---

### メディア運営も、人事だけではできなかった！
求人ページの作成、スカウトの送付、社員インタビューの作成など、<br>
できる限り社員を巻き込むと持ち得るパワーが10倍、20倍に！

---

### メディア運営をしていたら、自社に資産が溜まっていた！
社員インタビューや日々を綴ったコンテンツは、会社をPRする宝です。<br>
あらゆるところで使えます。<br>
これからも質の高いコンテンツを、（大変だけど）継続して出していきたい！
